...
import {FACING, vector} from '../const';
...
export interface DungeonOptions {
    size: vector, 
    seed?: string, //omit for generated seed
    rooms: DungeonOptionsRooms,
    max_corridor_length: number,
    min_corridor_length: number,
    corridor_density: number, //corridors per room ( decimal )
    symmetric_rooms: boolean, // exits must be in the center of a wall if true
...
export interface DungeonOptionsRooms {
...
export interface RoomConfig {
    ...
    max_size: vector,
    max_exits: number,
    position?: vector //OPTIONAL pos of initial room 
}