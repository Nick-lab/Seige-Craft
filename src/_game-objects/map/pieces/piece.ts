...
import Dungeon, { DungeonOptions, DungeonOptionsRooms } from '../generators/dungeon';
...
export default class Piece {
    ...
    get_perimeter_by_facing(facing: number) {
    ...
    add_perimeter(p_from: vector, p_to: vector, facing: number) {
    ...
    add_piece(piece: Piece, position: null | vector = null) {
